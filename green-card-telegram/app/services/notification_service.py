...
DEFAULT_NOTIFICATION_TEMPLATES: dict[tuple[str, str, str], str] = {
    ...
    ("calculator_followup", "client", "ru"): "Вы рассчитывали стоимость Green Card.\n\nТип ТС: {vehicle_type}\nСрок: {period_days} дней\nПредварительная стоимость: {estimated_price} {currency}\n\nПродолжить оформление?",
    ("draft_30_minutes", "client", "ru"): "Вы начали оформление Green Card, но не завершили заявку.\n\nХотите продолжить?",
    ("draft_24_hours", "client", "ru"): "Ваша заявка на Green Card ещё не завершена.\n\nЕсли полис всё ещё нужен, вы можете продолжить оформление.",
