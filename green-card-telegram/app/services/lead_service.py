...
class LeadService:
    ...
    def create_application_leads(self, app_data: ApplicationCreate, telegram_username: str | None = None, telegram_user_id: int | None = None, telegram_chat_id: int | None = None) -> dict:
        ...
        for vehicle in app_data.vehicles:
            deal_payload = self._build_deal_payload(app_data, vehicle.model_dump(), contact_id, company_id, telegram_chat_id or telegram_user_id)
    ...
    def _build_deal_payload(self, app_data: ApplicationCreate, vehicle: dict, contact_id: int, company_id: int | None, telegram_chat_id: int | None = None) -> dict:
