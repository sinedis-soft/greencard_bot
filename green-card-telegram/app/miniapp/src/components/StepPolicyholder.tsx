...
export default function StepPolicyholder({ form, setForm }: any) {
  ...
  return <div>
    ...
    <input value={form.passport_series_number} onChange={(e)=>setForm({...form, passport_series_number:e.target.value.trim().toUpperCase()})} placeholder="passport_series_number"/>
