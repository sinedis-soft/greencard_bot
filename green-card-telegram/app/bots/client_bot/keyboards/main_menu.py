...
def main_menu_keyboard(i18n: I18nService, lang: str) -> ReplyKeyboardMarkup:
    ...
    builder.button(text=i18n.get_text(lang, "main_menu.latest_deal"))
    builder.button(text=i18n.get_text(lang, "main_menu.my_applications"))
    builder.button(text=i18n.get_text(lang, "main_menu.payment_confirmation"))
